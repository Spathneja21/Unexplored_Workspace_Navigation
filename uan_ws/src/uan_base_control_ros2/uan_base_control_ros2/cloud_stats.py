...
Identical to the ROS 1 uan_base_control/cloud_stats.py - this tool has no ROS
dependency, only the invocation changes:

    ros2 run uan_base_control_ros2 cloud_stats ~/uan_maps/exports/room_3d_cloud.ply
"""
